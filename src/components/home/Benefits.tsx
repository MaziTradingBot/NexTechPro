...
export function Benefits() {
  const { t } = useI18n();
  return (
    <section className="wrap relative z-10 mt-8">
      <div className="grid gap-4 rounded-2xl border border-white/10 bg-surface p-4 sm:grid-cols-2 sm:p-6 lg:grid-cols-4">
